# This is the old version, the new version reads from a file.

puts "Information: (no spaces between the comas)"
puts "nation,event,sex,name"
...
#Change the following to normal prints/puts, and it will output to the terminal
